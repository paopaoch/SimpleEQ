...
void SimpleEQAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    ...
    *rightChain.get<ChainPositions::Peak>().coefficients = *peakCoefficients;
    ...
    auto cutCoefficients = juce::dsp::FilterDesign<float>::designIIRHighpassHighOrderButterworthMethod(chainSettings.lowCutFreq, sampleRate, (chainSettings.lowCutSlope + 1) * 2); // gives 2 4 6 8
...
void SimpleEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    *rightChain.get<ChainPositions::Peak>().coefficients = *peakCoefficients;
    ...
    auto cutCoefficients = juce::dsp::FilterDesign<float>::designIIRHighpassHighOrderButterworthMethod(chainSettings.lowCutFreq, getSampleRate(), (chainSettings.lowCutSlope + 1) * 2); // gives 2 4 6 8
...
juce::AudioProcessorValueTreeState::ParameterLayout SimpleEQAudioProcessor::createParameterLayout() // define method which generate parameter layout
{
    ...
    juce::StringArray stringArray; // prep string array for choice
    for( int i = 0; i<4; ++i)
    {
        juce::String str;
        str << (12 + i*12);
